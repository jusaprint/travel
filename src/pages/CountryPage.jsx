...
// Benefit card for Why choose section
...
// Quick features data, using translation keys
const quickFeatures = [
...
export default function CountryPage() {
  ...
  if (countryLoading||packagesLoading||translationsLoading) {
    return <div className="min-h-screen bg-[#f9f9ff] pt-24 flex items-center justify-center">
  ...
  return (
    <>
      <SEO
        ...
        description={`Reliable mobile data for ${getTranslatedCountryName()} with KudoSIM eSIM.`}
                      ...
                      <svg className="w-5 h-5 text-[#6a0dad] flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                          d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493
                             ...
                             a1 1 0 011.21-.502l4.493 1.498
                             a1 1 0 01.684.949V19a2 2 0 01-2 2h-1
                             C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                      <p className="ml-3 text-gray-700">
                        Includes a free international phone number.{' '}
                        <a href="#" className="text-[#6a0dad] font-medium">Learn more</a>.
                      </p>
                    </div>
                    <div className="flex items-start">
                      <svg className="w-5 h-5 text-[#6a0dad] flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white shadow-lg border-t border-gray-200 p-4 z-50">
          <div className="max-w-7xl mx-auto">
            <button 
              ...
              onClick={() => alert(`Processing purchase for ${selectedPackage.name} at $${selectedPackage.price}`)}
            >
              {selectedPackage 
